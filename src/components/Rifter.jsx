const Rifter = () => {
  return (<div style={{marginLeft: '1rem'}}>
    ...
    <p>Cancelling the startup frames from your falling animation can be done in one of two ways: 1. <strong>Frame Perfect Jump&nbsp;</strong></p>
